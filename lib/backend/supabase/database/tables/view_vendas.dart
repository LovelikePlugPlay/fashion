...
class ViewVendasTable extends SupabaseTable<ViewVendasRow> {
  @override
  String get tableName => 'view_vendas';

  @override
  ViewVendasRow createRow(Map<String, dynamic> data) => ViewVendasRow(data);
}

class ViewVendasRow extends SupabaseDataRow {
  ViewVendasRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewVendasTable();
