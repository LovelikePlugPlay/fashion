...
Future gerarPDFResultadoDetalhado(
    List<DtResultadoDetalhadoStruct> resultados) async {
        ...
        build: (pw.Context context) {
          return [
            pw.Row(
              ...
              children: [
                pw.Text('Relatório Detalhado Fatura Visa',
                    style: pw.TextStyle(
            ...
            pw.Table(
              ...
              children: [
                ...
                ...resultados.map((resultado) {
                  print(
                      'Processando resultado: ${resultado.nome}'); // Log para debug
                  return pw.TableRow(
                    children: [
                      resultado.nome ?? 'N/A',
                      resultado.tipoCobranca ?? 'N/A',
                      formatarMoeda(resultado.valorCompra),
