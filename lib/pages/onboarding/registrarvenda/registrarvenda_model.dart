...
import 'registrarvenda_widget.dart' show RegistrarvendaWidget;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class RegistrarvendaModel extends FlutterFlowModel<RegistrarvendaWidget> {
  ...
  // Stores action output result for [Backend Call - API (Api Usuarios )] action in registrarvenda widget.
